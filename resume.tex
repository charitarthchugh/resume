...
%    \location{Upcoming (Spring 2023):}
    ...
    \textbullet{} Responsible for planning and\\ leading weekly meetings\\
    \textbullet{} Lead the Special Projects Group to \\do open-source contributions to LiquidPrep, an organization helping farmers
...
\begin{minipage}[t]{0.66\textwidth}
    ...
    \vspace{\topsep}
    \begin{tightemize}
        \item Developing a cross-platform bookmark manager using Fast API, SQLite \& Flutter.
        \item Served as the Lead Developer and Project Manager in a small team
        \item Developed CLI interface, API, daemon and was responsible for Python packaging.
...
%     \vspace{\topsep}
    ...
    Working under \textbf{\href{https://caiwending.cse.uconn.edu/}{Prof Caiwen Ding}} to develop optimized machine learning models for object detection tasks on embedded devices, using techniques such as sparsity and quantization.
    Additionally working with autonomous vehicle systems involving LiDAR and point cloud deep learning models.
    \sectionsep
    ...
    \descript{ | HackUMass 10, November 2022}
    \begin{tightemize}
