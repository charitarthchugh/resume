...
%    \location{Upcoming (Spring 2023):}
        ...
        \textbullet{} Lead the Special Projects Group \\to do open-source contributions to LiquidPrep, an organization helping farmers
    ...
    \begin{minipage}[t]{0.66\textwidth}
        ...
        \vspace{\topsep}
        \begin{tightemize}
            \item Developed a cross-platform bookmark manager using FastAPI, SQLite \& Flutter
            \item Managed a 5-person cross-functional team {frontend, backend}
