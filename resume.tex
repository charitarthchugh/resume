...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Charitarth Chugh}{}{ \urlstyle{same}\href{https://charitarth.dev}{charitarth.dev} |
    \href{mailto:contact@charitarth.dev}{contact@charitarth.dev} | 475.434.6427}
...
\begin{minipage}[t]{0.66\textwidth}
    ...
    \vspace{\topsep}
    \begin{tightemize}
        \item Bookie is a bookmark manager created using Fast API, SQLite and Flutter.
        \item Served as the Lead Developer and Project Manager in a 4 person team. As the lead developer, I was responsible for the command line interface, API design, daemon, and Python Packaging
    ...
    % \end{tightemize}
    % \sectionsep
    \runsubsection{NeatBot}\label{subsec:pulsar-identification}
    \descript{| MLOps}
    \location{June 2022}
    \begin{tightemize}
        \item Deployed a NLP model on Google Cloud using Docker as a Discord bot that detects the code language being used and applies the correct Markdown syntax highlighting 
        %\item Used Numpy, Pandas, and PyTorch to create a custom Logistic Regression model.
    \end{tightemize}
